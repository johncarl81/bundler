...
public final class Bundles {
    ...
    public static final String BUNDLER_NAME = "Bundler";
    public static final String BUNDLER_REPOSITORY_NAME = "Bundler$Repsitory";
    public static final String BUNDLER_PACKAGE = "org.bundler";
    public static final String IMPL_EXT = "BundlerImpl";
     ...
     *
     * @throws BundlerRuntimeException if there was an error looking up the wrapped Silver$Repository class.
    ...
    private static final class SilverImplReflectionProxy<T> implements SilverImplementation<T> {
        ...
        public SilverImplReflectionProxy(Class<T> parcelWrapperClass) {
            try {
                ...
                throw new BundlerRuntimeException("Unable to create ParcelFactory Type", e);
            }
        }
    ...
    private static final class ParcelCodeRepository {
        ...
        public <T> SilverImplementation<T> get(Class<T> clazz){
            ...
            if (result == null) {
                ...
                if(value == null){
                    throw new BundlerRuntimeException("Unable to create SilverImplementation for " + clazz.getName());
                }
         ...
         * then this method will throw a BundlerRuntimeException.
         *
         * @throws BundlerRuntimeException
         * @param classLoader
         */
        @SuppressWarnings("unchecked")
        public void loadRepository(ClassLoader classLoader){
            try{
                Class repositoryClass = classLoader.loadClass(BUNDLER_PACKAGE + "." + BUNDLER_REPOSITORY_NAME);
                ...
                throw new BundlerRuntimeException("Unable to instantiate generated Repository", e);
            } catch (IllegalAccessException e) {
                throw new BundlerRuntimeException("Unable to access generated Repository", e);
            }
        }
    }
